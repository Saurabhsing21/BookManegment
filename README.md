...
### connect to AWS and store the imageCover
 - 1: postman/frontend sends a file to our node server in an API call
 - 2: Multer is able to grab that file and make it available to node server
 - 3: uploading this file to AWS S3
